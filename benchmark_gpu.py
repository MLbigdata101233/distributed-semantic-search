...
df = pd.read_parquet("/data/m25_jahanvi/ML_big/combined_data/data/combined_embeddings_parquet")
...
ivf_index = faiss.read_index("/data/m25_jahanvi/ML_big/combined_data/faiss_index_gpu.index")
index_size_mb = os.path.getsize("/data/m25_jahanvi/ML_big/combined_data/faiss_index_gpu.index") / 1e6
